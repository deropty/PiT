...
class BaseDataset(object):
    ...
    def get_imagedata_info(self, data):
        ...
        for img_paths, pid, camid, trackid in data:
...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        img_paths, pid, camid, tracklet_id = self.dataset[index]
        ...
        return clip, pid, camid, tracklet_id, [i.split('/')[-1] for i in img_paths]